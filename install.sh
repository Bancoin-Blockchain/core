...
echo 'alias bancoin="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/Bancoin-Blockchain/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Bancoin-Blockchain/core'"
...
rm -rf "$HOME/.config/@bancoin"
rm -rf "$HOME/.config/@bancoin"
rm -rf "$HOME/.config/bancoin-core"
